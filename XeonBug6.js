...
const xtime = moment.tz('Asia/Kolkata').format('HH:mm:ss')
        ...
        const time2 = moment().tz('Asia/Kolkata').format('HH:mm:ss')  
         if(time2 < "23:59:00"){
var xeonytimewisher = `Good Night DON'T FORGET TO PRAY`
 }
 if(time2 < "19:00:00"){
var xeonytimewisher = `Good Evening LET'S HACK THEM COZ WE'RE VENOM`
 }
 if(time2 < "18:00:00"){
var xeonytimewisher = `Good Evening LET'S HACK THEM COZ WE'RE VENOM`
 }
 if(time2 < "15:00:00"){
var xeonytimewisher = `Good Afternoon LET'S HACK THEM COZ WE'RE VENOM`
 }
 if(time2 < "11:00:00"){
var xeonytimewisher = `Good Morning LET'S HACK THEM COZ WE'RE VENOM`
 }
 if(time2 < "05:00:00"){
var xeonytimewisher = `Good Morning LET'S HACK THEM COZ WE'RE VENOM`
 } 
